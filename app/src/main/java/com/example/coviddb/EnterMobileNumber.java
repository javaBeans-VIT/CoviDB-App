...
public class EnterMobileNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enter_mobile_number);
         ...
         getotpbutton = findViewById(R.id.buttontootp);
                 ...
                 if(!enternumber.getText().toString().trim().isEmpty())
                 {
                     if((enternumber.getText().toString().trim()).length()==10){
                         ...
                         PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                 ...
                                 TimeUnit.SECONDS, EnterMobileNumber.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                     @Override
...
//                         startActivity(intent);
                     ...
                     {
                         Toast.makeText(EnterMobileNumber.this, "Please enter a valid number", Toast.LENGTH_SHORT).show();
                     }
                 }else{
